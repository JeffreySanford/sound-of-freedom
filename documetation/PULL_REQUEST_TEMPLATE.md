...
Please check the following before creating a PR. Use the checklist to ensure your PR passes basic requirements and lint
checks.
...
- If your PR contains large model artifacts, prefer referencing artifacts externally (cloud storage or huggingface
  link).
